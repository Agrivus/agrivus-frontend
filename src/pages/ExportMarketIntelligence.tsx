        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li>• Rising price trends indicate good export opportunities</li>
              <li>• High demand + low competition = ideal market conditions</li>
              <li>• Review regulations early to ensure compliance readiness</li>
              <li>

...
interface TransportOfferWizardProps {
  orderId: string;
...
export const TransportOfferWizard: React.FC<TransportOfferWizardProps> = ({
  orderId,
  pickupLocation,
  transportCost,
  onSuccess,
      ...
      <div className="px-6 py-4">
        ...
        {step === "select-primary" && (
          <div>
            ...
            <p className="text-gray-600 mb-4 text-sm">
              This transporter gets priority access for 1 hour. Select your top
              choice.
            </p>
        ...
        {step === "select-tertiary" && (
          <div>
            ...
            <p className="text-gray-600 mb-4 text-sm">
              If secondary also doesn't respond, offer goes here. Leave empty if
              you only want 2 tiers.
            </p>
            <button
        ...
        {step === "summary" && (
          <div>
            <h3 className="text-lg font-bold mb-4">Review Your Selections</h3>
        ...
        {step === "loading" && (
          <div className="flex items-center justify-center p-8">
            <div className="text-center">
              <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-green-500 mb-4"></div>
              <p className="text-gray-600">Sending offers to transporters...</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="border-t border-gray-200 p-6 flex gap-3">
        ...
        {step !== "loading" && (
          <>
            ...
            >
              {step === "summary" ? "Confirm & Send Offers" : "Next"}
              <span>→</span>
            </button>
          </>
        )}
